...
(deftest should-generate-holidays-when-holidays-for-year-with-easter-expression-and-observance-rule
  (are [expected year]
    ...
    [{:name "Easter" :date (t/date "2012-04-09")}] 2012
    [{:name "Easter" :date (t/date "2013-04-01")}] 2013
    [{:name "Easter" :date (t/date "2014-04-21")}] 2014
    [{:name "Easter" :date (t/date "2015-04-06")}] 2015
    [{:name "Easter" :date (t/date "2016-03-28")}] 2016
    [{:name "Easter" :date (t/date "2017-04-17")}] 2017
    [{:name "Easter" :date (t/date "2018-04-02")}] 2018))
