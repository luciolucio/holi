(ns com.piposaude.add-test.years-test
...
(deftest should-calculate-correct-date-when-add-date-with-years
  (are [days expected]
       (= expected (calendar/add (t/date "2020-02-29") days :years))
    0 (t/date "2020-02-29")
    1 (t/date "2021-02-28")
...
(deftest should-calculate-correct-date-when-add-date-time-with-years
  (are [days expected]
       (= expected (calendar/add (t/date-time "2020-02-29T10:15:00") days :years))
