(ns com.piposaude.add-test.months-test
...
(deftest should-calculate-correct-date-when-add-date-with-months
  (are [days expected]
       (= expected (calendar/add (t/date "2020-07-31") days :months))
    0 (t/date "2020-07-31")
    1 (t/date "2020-08-31")
...
(deftest should-calculate-correct-date-when-add-date-time-with-months
  (are [days expected]
       (= expected (calendar/add (t/date-time "2020-07-31T10:15:00") days :months))
