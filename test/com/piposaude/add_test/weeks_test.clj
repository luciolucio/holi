(ns com.piposaude.add-test.weeks-test
...
(deftest should-calculate-correct-date-when-add-date-with-weeks
  (are [days expected]
       (= expected (calendar/add (t/date "2020-07-29") days :weeks))
    0 (t/date "2020-07-29")
    1 (t/date "2020-08-05")
...
(deftest should-calculate-correct-date-when-add-date-time-with-weeks
  (are [days expected]
       (= expected (calendar/add (t/date-time "2020-07-29T10:15:00") days :weeks))
