(ns com.piposaude.relative-date-test.business-days-missing-calendar-test
  (:require [clojure.test :refer :all]
            [com.piposaude.relative-date-add :refer [relative-date-add]]
            [tick.core :as t]))

(deftest should-calculate-correct-date-when-relative-date-add-date-with-business-days-unknown-calendar
  (are [days expected]
       (= expected (relative-date-add (t/date "2020-07-30") days :business-days "X"))
    2 (t/date "2020-08-03")
    1 (t/date "2020-07-31")
    5 (t/date "2020-08-06")
    -5 (t/date "2020-07-23")))

(deftest should-calculate-correct-date-when-relative-date-add-date-time-with-business-days-unknown-calendar
  (are [days expected]
       (= expected (relative-date-add (t/date-time "2020-07-30T11:11:00") days :business-days "Y"))
