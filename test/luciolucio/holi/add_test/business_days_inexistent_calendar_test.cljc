...
(ct/deftest
  ...
  should-throw-when-add-date-with-business-days-and-inexistent-calendar-and-result-beyond-limit-years
  (ct/are [date n]
...
(ct/deftest
  ^{:doc "This test relies on TEST-WEEKEND.datelist, which lists weekends in 2020.
          Any result outside 2020 should raise an exception"}
  should-throw-when-add-date-time-with-business-days-and-inexistent-calendar-and-result-beyond-limit-years
  (ct/are [date n]
