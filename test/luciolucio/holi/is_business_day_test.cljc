...
(defcalendartest should-identify-business-days-when-business-days?-with-date
...
(defcalendartest should-default-weekend-option-to-sat-sun-when-business-day?-with-no-weekend-option
  (ct/testing "date"
    (ct/testing "[date]"
...
(defcalendartest should-throw-when-business-day?-with-inexistent-calendar-or-starting-with-WEEKEND
